...
<form action="./${bean.deptno}" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="dname" class="form-control" id="dname" value="${bean.dname }" readonly>
  </div>
  <div class="form-group">
    <label for="loc">loc</label>
    <input type="text" name="loc" class="form-control" id="loc" value="${bean.loc }" readonly>
  </div>
