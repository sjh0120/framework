...
import com.bit.stst04.model.EmpDao;
import com.bit.stst04.model.EmpVo;
...
public class EmpController {
	...
	public String insert(@RequestParam int empno, @RequestParam("sal") int sal
						, @RequestParam("ename") String name, String job
						) throws SQLException {
